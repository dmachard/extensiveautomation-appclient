...
class DataModel(GenericModel.GenericModel):
    ...
    def toXml (self):
        ...
        try:
            # !!!!!!!!!!!!!!!!!!!!!!!!!!
            self.fixPyXML( data = self.properties['properties']['parameters'], key = 'parameter' )
            # !!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    if type(properties['parameters']) == str or type(properties['parameters']) == bytes:  # python3 support
                        properties['parameters'] = { 'parameter':[], '@parameter':[] }
