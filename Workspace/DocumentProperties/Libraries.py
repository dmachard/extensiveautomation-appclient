...
try:
    from PyQt4.QtGui import (QColor, QItemDelegate, QMessageBox, QDialog, QLineEdit, QTableView, 
                            QSortFilterProxyModel, QFrame, QAbstractItemView, QIcon, QMenu, QWidget, 
    ...
    from PyQt5.QtWidgets import (QItemDelegate, QMessageBox, QDialog, QLineEdit, QTableView, 
                                QFrame, QAbstractItemView, QMenu, 
...
class DescriptionTableModel(QAbstractTableModel):
    ...
    def data(self, index, role=Qt.DisplayRole):
        ...
        if role == Qt.BackgroundColorRole:
            if self.mydata[ index.row() ]['action'] == ACTION_LIBRARY:
...
class LibrariesTableView(QTableView):
    """
    Libraries table view
    """
    ...
    def addLibrary(self, fctParams):
        ...
        tpl = { 'action': ACTION_LIBRARY,  'data': fctParams }
    ...
    def setLibraries(self, libraries):
        ...
        Set libraries
        """
        self.model.setDataModel( libraries )
...
class LibrariesQWidget(QWidget, Logger.ClassLogger):
    """
    Libraries widget
    """
    ...
    def clear(self):
        ...
        Clear all widget
        """
        self.librariesTable.clear()

    def table(self):
        """
        Return the libraires table view
        """
        return self.librariesTable