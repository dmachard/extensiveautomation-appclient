...
class FileLogArgs(QtHelper.EnhancedQDialog, Logger.ClassLogger):
    """
    File logs arguments dialog
    """
    def __init__(self, dataArgs, parent=None):
        """
        Dialog to fill arguments for the log file probe
        ...
        @type parent:
        """
        super(FileLogArgs, self).__init__(parent)
    ...
    def createDialog (self):
        ...
        self.labelHelp = QLabel("Path of the file log to follow:") 
        ...
        self.setWindowTitle("File Log Probe > Arguments")
    ...
    def getArgs(self):
        """
        Returns arguments
        Example list of files: {'files': [ '/var/log/messages' ] }
        """
        listFiles = []
        model = self.listBox.model()
