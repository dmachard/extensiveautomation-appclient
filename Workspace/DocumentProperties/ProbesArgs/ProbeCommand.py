...
class CommandArgs(QtHelper.EnhancedQDialog, Logger.ClassLogger):
    """
    Command arguments dialog
    """
    def __init__(self, dataArgs, parent=None):
        ...
        @type parent:
        """
        super(CommandArgs, self).__init__(parent)
    ...
    def createDialog (self):
        ...
        self.labelHelp = QLabel("Command to execute:") 
        ...
        self.setWindowTitle("Command Probe > Arguments")
    ...
    def loadDefaultData(self):
        ...
        try:
            ...
            if 'commands' in dat:
                list_files = dat['commands']
                self.listBox.insertItems(0, list_files)
        except Exception as e:
            self.error( "unable to set the default data: %s" % e )

    def getArgs(self):
        """
        Returns arguments
        Example: {'commands': [ 'date' ] }
        """
        listFiles = []
        model = self.listBox.model()
